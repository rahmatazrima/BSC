...
Tampilan aplikasi dirancang dengan prinsip \textit{user-centered design} yang mengutamakan kemudahan penggunaan, responsivitas, dan estetika visual. Antarmuka pengguna dibangun menggunakan Next.js dengan React sebagai \textit{framework} utama, Tailwind CSS untuk \textit{styling}, dan komponen UI dari \textit{shadcn/ui} untuk memastikan konsistensi desain. Sistem ini diimplementasikan sebagai \textit{Progressive Web App} (PWA) sehingga dapat diakses dengan baik di berbagai perangkat dan dapat diinstal seperti aplikasi \textit{native}. Berikut adalah penjelasan tampilan aplikasi untuk setiap peran pengguna:

% LETAKKAN SCREENSHOT-SCREENSHOT TAMPILAN APLIKASI DI SINI
% Sertakan screenshot untuk:
% 1. Halaman Homepage
% 2. Halaman Login dan Registrasi
